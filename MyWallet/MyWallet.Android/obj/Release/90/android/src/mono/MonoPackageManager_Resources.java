...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "IdentifyMe.Android.dll" comes first in this list. */
		...
		"Flurl.dll",
		"FormsViewGroup.dll",
		"Hyperledger.Aries.dll",
		"Hyperledger.Aries.Routing.dll",
		"Hyperledger.Aries.Routing.Edge.dll",
