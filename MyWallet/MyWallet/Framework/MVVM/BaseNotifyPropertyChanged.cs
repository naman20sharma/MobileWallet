...
namespace IdentifyMe.MVVM
{
    public class BaseNotifyPropertyChanged : INotifyPropertyChanged
    {
        ...
        protected bool RaiseAndUpdate<T>(ref T field, T value, Action onChanged,
            [CallerMemberName] string propertyName = null)
        {
            if (!RaiseAndUpdate(ref field, value, propertyName)) 
                return false;
        ...
        protected void Raise(string propertyName)
        {
            ...
            if (!_propertyWatchers.TryGetValue(propertyName, out var watchers)) return;
